...
import useAnalisisIngles from '../hooks/useAnalisisIngles';
...
const MetodoIngles = () => {
  ...
  return (
    <div className="container " align="center">
      ...
      <h2>Analizador Metodo Inglés</h2>
      ...
      <div>
        <form className='form' onSubmit={ ev =>{
          ...
          <button type='submit' onClick={
            useAnalisisIngles(datos[0], datos[1], datos[2], setResultado)
          }>iniciar</button>
